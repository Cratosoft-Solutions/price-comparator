  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md max-h-full">
        <div className="relative bg-dark-surface rounded-lg shadow">
          <div className="p-6 text-center">
            <svg
              className="mx-auto mb-4 text-dark-muted w-8 h-8"
              aria-hidden="true"
            ...
            <h3 className="mb-5 text-lg font-normal text-dark-muted">
              {message}
            </h3>
            <button
              onClick={() => {
              ...
              type="button"
              className="text-white bg-black hover:bg-green-100 hover:text-dark-muted hover:border hover:border-green-100 hover:shadow-lg  focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2 mb-4"
            >
              {okText}
            </button>
            {showCancelButton && (
              <button
                ...
                data-modal-hide="popup-modal"
                type="button"
                className="text-dark-muted bg-dark-surface hover:bg-red-100 hover:text-dark-muted hover:border hover:border-red-100 hover:shadow-lg  focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-dark-border text-sm font-medium px-5 py-2.5 hover:text-dark-text focus:z-10"
              >
                {cancelText}
              </button>
            )}
