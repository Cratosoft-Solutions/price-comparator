...
const HorizontalMainInfo = () => {
  return (
    <div className='mr-2 ml-2 lg:mr-10 lg:ml-10'>
        <div className="w-full mb-12 "><span className="font-[1000] text-2xl mt-6 flex text-center justify-center w-full ">¿Por qué anunciarme con EncuentraloFácilCR?</span></div>
