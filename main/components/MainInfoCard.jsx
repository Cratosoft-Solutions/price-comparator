...
const MainInfoCard = ({Icon, title, description}) => {
  return (
    <div className='w-full p-4 relative mb-4'>
        ...
        <div className='text-center w-full h-fit p-8 rounded-lg border bg-white hover:shadow-[3px_3px_3px_3px_rgba(0.3,0.3,0.3,0.3)] pt-16 pl-2 pr-2 md:pl-8 md:pr-8 justify-center'>
