  ...
  return (
    <div className='w-full bg-[#D9D9D9] h-26 mt-auto grid grid-rows-3 justify-center p-2'>
      <div  className='flex justify-center items-center'>
        <span className='text-black font-black text-xl h-10 mt-8'>
          Encuéntralo Fácil
        </span>
      </div>
      <div className='grid grid-rows-2 grid-cols-2 lg:grid-rows-1 lg:grid-cols-3 w-full'>
        <button onClick={()=>{onOptionSelected("/sale")}} className='text-black w-full justify-center flex'>
          Publica tu producto o servicio
        </button>
        <button onClick={()=>{onOptionSelected("/promotion")}} className='text-black w-full justify-center flex'>
          Promociona tu sitio web
        </button>
        <button onClick={()=>{onOptionSelected("/howtouse")}} className='text-black w-full justify-center flex'>
          ¿Cómo funciona?
        </button>
      </div>
