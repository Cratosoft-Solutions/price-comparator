...
const ProductDetails = ({onCloseFunction, storeId, productId, adminMode=false}) => {
    ...
    useEffect(() => {
      ...
      if(editingProduct)
      return (
        <section className="absolute top-0 w-full z-50 h-screen bg-black bg-opacity-30 py-11 left-0">
    ...
    return (
      <section className="absolute top-0 w-full z-50 h-screen bg-black bg-opacity-30 lg:py-11 left-0">
