  ...
  return ( <>
          <div className="md:col-span-5 relative">
            ...
            <div className="md:col-span-5 relative">
              ...
              <div
                className={`${
                    houseInfo.porpertyMeters ? "labelsconfigurationwithvalue" : "labelsconfiguration"
            ...
            <div className="md:col-span-5 relative">
              ...
              <div
                className={`${
                    houseInfo.address ? "labelsconfigurationwithvalue" : "labelsconfiguration"
                } text-gray-600 text-sm`}
              >
                Dirección exacta.
              </div>
            ...
            <div className="md:col-span-5 relative">
              ...
              <div
                className={`${
                    houseInfo.propertyMaintenanceCosts ? "labelsconfigurationwithvalue" : "labelsconfiguration"
                } text-gray-600 text-sm`}
              >
            ...
            <div className="md:col-span-5 relative">
             {/*  <div className="md:col-span-3 relative"> */}
                ...
                <div
                  className={`${
                      houseInfo.lotSize ? "labelsconfigurationwithvalue" : "labelsconfiguration"
                  } text-gray-600 text-sm`}
                >
                  Tamaño del lote.
                </div>
...
{/*                 <div className="md:col-span-2 relative">
            ...
            <div className="md:col-span-5 relative">
              ...
              <div
                className={`${
                    houseInfo.height ? "labelsconfigurationwithvalue" : "labelsconfiguration"
                } text-gray-600 text-sm`}
              >
                Altura.
              </div>
            ...
            <div className="md:col-span-5 relative ">
                <div className="orange_gradient text-3xl p-6 text-center">Extras - Beneficios</div>
            </div>
