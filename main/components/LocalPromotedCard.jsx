...
const LocalPromotedCard = ({ product, index, callBackFunction }) => {
  ...
  return (
    <div key={`CARD-${index}`} className=" hover:cursor-pointer flex flex-col w-32 h-fit  lg:w-fit lg:h-fit mr-4 bg-dark-surface rounded-t-lg lg:rounded-none	 overflow-hidden border border-1">
