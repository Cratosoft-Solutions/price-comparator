  ...
  return (
    <>
      ...
      <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-1 p-6 ml-10 mt-4 mb-4 mr-10 ">
        ...
        <p className="text-dark-muted text-lg font-semibold leading-relaxed px-0 py-2 text-center lg:text-left">
        ...
        <div class="flex w-full justify-center lg:justify-start mt-4">
          <a class="relative black_btn_sqr" href="/create/item?type=product">
            <div class="absolute rounded-full bg-accent-primary animate-ping h-4 w-4 -top-1 -right-1 "></div>
            Publicar mi anuncio
          </a>
        </div>
      </div>
      ...
      <h2 className="text-4xl font-extrabold text-dark-text mb-4 ">
        ...
        <ul className="list-disc ml-10 gap-2 text-justify text-dark-muted text-lg font-semibold leading-relaxed px-0 py-2 lg:text-left">
          <li key={1} className="mb-2">
            <p className="inline">
              <p className="inline font-black text-dark-text">Busca lo que necesitas: </p>En nuestra plataforma podrás encontrar desde productos hasta servicios, te invitamos a utilizar las diferentes opciones de búsqueda, siempre ubicadas en la zona inicial de cada página de navegación. Busca lo que necesitas y contacta directamente con el vendedor sin intermediarios!
            </p>
          </li>
          <li key={2} className="mb-2">
            <p className="inline">
              <p className="inline font-black text-dark-text">Publica lo que quieras vender: </p>Nuestra plataforma está diseñada pensando en ti. Es intuitiva y fácil de navegar, permitiéndote publicar y gestionar tus productos sin complicaciones.
            </p>
          </li>
          <li key={3} className="mb-2">
            <p className="inline">
              <p className="inline font-black text-dark-text">Incremento en Ventas: </p>Más visibilidad significa más oportunidades de venta. Atrae a una base de clientes más amplia y diversificada.
            </p>
          </li>
          <li key={4} className="mb-2">
            <p className="inline">
              <p className="inline font-black text-dark-text">Soporte Local: </p>Disfruta del respaldo de un equipo local que entiende tus necesidades y está dispuesto a ayudarte en cada paso del camino.
            </p>
          </li>
        </ul>
      </div>
